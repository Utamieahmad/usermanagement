    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-success color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">{{ $total_roles }}</h2>
                    <div class="m-b-5">Roles</div><i class="ti-shopping-cart widget-stat-icon"></i>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-info color-white widget-stat">
                <div class="ibox-body">
                    ...
                    <div class="m-b-5">Admin</div><i class="ti-bar-chart widget-stat-icon"></i>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ibox bg-warning color-white widget-stat">
                <div class="ibox-body">
                    <h2 class="m-b-5 font-strong">{{ $total_permissions }}</h2>
                    <div class="m-b-5">Permissions</div><i class="fa fa-money widget-stat-icon"></i>
