...
<head>
    ...
    <link href="{{ asset('template/assets/vendors/themify-icons/css/themify-icons.css') }}" rel="stylesheet" />
    <!-- PLUGINS STYLES-->
    <link href="{{ asset('template/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet" />
    <!-- THEME STYLES-->
...
<body class="fixed-navbar">
                ...
                <ul class="nav navbar-toolbar">
                            ...
                            <li class="list-group list-group-divider scroller" data-height="240px" data-color="#71808f">
                                <div>
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('template/assets/img/users/u1.jpg') }}" />
                                            </div>
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('template/assets/img/users/u2.jpg') }}" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('template/assets/img/users/u3.jpg') }}" />
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <a class="list-group-item">
                                        <div class="media">
                                            <div class="media-img">
                                                <img src="{{ asset('template/assets/img/users/u4.jpg') }}" />
                                            </div>
                                            <div class="media-body">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            <img src="{{ asset('template/assets/img/admin-avatar.png') }}" />
                            ...
                            <div class="ibox-body">
                                ...
                                <table class="table table-striped m-t-20 visitors-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('template/assets/img/flags/us.png') }}" />USA</td>
                                            <td>755</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('template/assets/img/flags/Canada.png') }}" />Canada</td>
                                            <td>700</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('template/assets/img/flags/India.png') }}" />India</td>
                                            <td>410</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('template/assets/img/flags/Australia.png') }}" />Australia</td>
                                            <td>304</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('template/assets/img/flags/Singapore.png') }}" />Singapore</td>
                                            <td>203</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('template/assets/img/flags/uk.png') }}" />UK</td>
                                            <td>202</td>
                                            <td>
                                                <div class="progress">
                                        ...
                                        <tr>
                                            <td>
                                                <img class="m-r-10" src="{{ asset('template/assets/img/flags/UAE.png') }}" />UAE</td>
                                            <td>180</td>
                                            <td>
                                                <div class="progress">
                                ...
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('template/assets/img/users/u1.jpg') }}" width="40" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('template/assets/img/users/u2.jpg') }}" width="40" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('template/assets/img/users/u3.jpg') }}" width="40" />
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img class="img-circle" src="{{ asset('template/assets/img/users/u6.jpg') }}" width="40" />
                                        </a>
                                        <div class="media-body">
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <ul class="media-list media-list-divider m-0">
                                    <li class="media">
                                        <a class="media-img" href="javascript:;">
                                            <img src="{{ asset('template/assets/img/image.jpg') }}" width="50px;" />
                                        </a>
                                        <div class="media-body">
                ...
                {{--<div>
                    <a class="adminca-banner" href="http://admincast.com/adminca/" target="_blank">
                        ...
                        <div class="wrap-1">
                            <div class="wrap-2">
                                <div>
                                    <img src="{{ asset('template/assets/img/adminca-banner/adminca-preview.jpg') }}" style="height:160px;margin-top:50px;" />
                                </div>
                            ...
                            <div style="flex:1;">
                                <div class="d-flex justify-content-end wrap-3">
                                    <div class="adminca-banner-b m-r-20">
                                        <img src="{{ asset('template/assets/img/adminca-banner/bootstrap.png') }}" style="width:40px;margin-right:10px;" />Bootstrap v4</div>
                                    <div class="adminca-banner-b m-r-10">
                                        <img src="{{ asset('template/assets/img/adminca-banner/angular.png') }}" style="width:35px;margin-right:10px;" />Angular v5+</div>
                                </div>
                                <div class="dev-img">
                                    <img src="{{ asset('template/assets/img/adminca-banner/sprite.png') }}" />
                                </div>
                            </div>
                        </div>
                    </a>
    ...
    <!-- END PAGA BACKDROPS-->
    <!-- CORE PLUGINS-->
    <script src="{{ asset('template/assets/vendors/jquery/dist/jquery.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('template/assets/vendors/popper.js/dist/umd/popper.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('template/assets/vendors/bootstrap/dist/js/bootstrap.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('template/assets/vendors/metisMenu/dist/metisMenu.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('template/assets/vendors/jquery-slimscroll/jquery.slimscroll.min.js') }}" type="text/javascript"></script>
    <!-- PAGE LEVEL PLUGINS-->
    <script src="{{ asset('template/assets/vendors/chart.js/dist/Chart.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('template/assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('template/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}" type="text/javascript"></script>
    <script src="{{ asset('template/assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.js') }}" type="text/javascript"></script>
    <!-- CORE SCRIPTS-->
    <script src="{{ asset('template/assets/js/app.min.js') }}" type="text/javascript"></script>
    <!-- PAGE LEVEL SCRIPTS-->
    <script src="{{ asset('template/assets/js/scripts/dashboard_1_demo.js') }}" type="text/javascript"></script>
</body>
